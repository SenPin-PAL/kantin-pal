...
<div class="card">
    <div class="card-header">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-secondary">Kembali ke Dashboard</a>
    </div>
    <div class="card-body">
            ...
            <div class="recap-item">
                <div class="recap-header" data-toggle="recap-<?php echo e($order->id); ?>">
                    <div class="recap-info">
                        ...
                        <span class="recap-meta">Outlet: <?php echo e($order->outlet->name); ?></span>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Kuliah\Magang\Project Internship\kantin-pal\resources\views/admin/recap.blade.php ENDPATH**/ ?>